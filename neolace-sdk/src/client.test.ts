...
Deno.test("Compile-time tests for typing of client.getEntry()", async () => {
    ...
    if (Math.random() < 0) {
        ...
        // Check with runtime flags:
        {
            ...
            // Type of propertiesSummary should be: { propertyKey: string; value: AnyLookupValue; }[] | undefined;
            checkType<
                AssertEqual<typeof propertiesSummary, { propertyKey: string; value: AnyLookupValue }[] | undefined>
            >();
            checkType<AssertNotEqual<typeof propertiesSummary, { propertyKey: string; value: AnyLookupValue }[]>>();
        ...
        // Check with compile-time flags:
        {
            ...
            checkType<AssertEqual<typeof propertiesSummary, { propertyKey: string; value: AnyLookupValue }[]>>();
            checkType<
                AssertNotEqual<typeof propertiesSummary, { propertyKey: string; value: AnyLookupValue }[] | undefined>
            >();
