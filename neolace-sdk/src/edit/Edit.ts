...
import { SchemaValidatorFunction, Type } from "../deps/computed-types.ts";
...
> {
    ...
    consolidate?: (
        thisEdit: Edit<EditType<string, DataSchema>>,
        earlierEdit: Edit<EditType<any, any>>,
    ) => undefined | Edit<EditType<any, any>> | Edit<EditType<any, any>>[];
}
