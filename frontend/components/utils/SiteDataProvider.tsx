...
import { SiteData, useSiteData } from 'lib/api-client';
import { UiPluginsProvider } from './ui-plugins';
 ...
 * 
 */
export const SiteDataProvider: React.FunctionComponent<Props> = (props) => {
