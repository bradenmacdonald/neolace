...
docker build --pull -t $CI_REGISTRY/neolace/neolace-app/frontend:$FRONTEND_IMAGE_TAG -f frontend/Dockerfile .
docker push $CI_REGISTRY/neolace/neolace-app/frontend:$FRONTEND_IMAGE_TAG
