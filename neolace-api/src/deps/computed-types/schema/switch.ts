...
// exported functions
export function findSwitchKey(...candidates: [unknown, ...unknown[]]): SwitchKey | null {
...
export function generateSwitch(switchKey: SwitchKey, validators: FunctionType[]): FunctionType {
