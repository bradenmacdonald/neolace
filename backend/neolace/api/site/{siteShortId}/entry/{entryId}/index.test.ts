            ...
            assertEquals(result.referenceCache, {
                ...
                properties: {
                    [defaultData.schema.properties._parentGenus.id]: {
                        ...
                        description: defaultData.schema.properties._parentGenus.description,
                        rank: defaultData.schema.properties._parentGenus.rank,
                        standardURL: "",
                        displayAs: "",
                    },
                    [defaultData.schema.properties._taxonomy.id]: {
                        ...
                        description: defaultData.schema.properties._taxonomy.description,
                        rank: defaultData.schema.properties._taxonomy.rank,
                        standardURL: "",
                        displayAs: "",
                    },
                    [defaultData.schema.properties._propScientificName.id]: {
                        ...
                        description: defaultData.schema.properties._propScientificName.description,
                    ...
                    [defaultData.schema.properties._hasPart.id]: {
                        ...
                        description: defaultData.schema.properties._hasPart.description,
                        rank: defaultData.schema.properties._hasPart.rank,
                        standardURL: "",
                        displayAs: "",
                    },
                    [defaultData.schema.properties._propWikidataQID.id]: {
                        ...
                        description: defaultData.schema.properties._propWikidataQID.description,
                        rank: defaultData.schema.properties._propWikidataQID.rank,
                        standardURL: "",
                    ...
                    [defaultData.schema.properties._relImages.id]: {
                        ...
                        description: defaultData.schema.properties._relImages.description,
                        rank: defaultData.schema.properties._relImages.rank,
                        standardURL: "",
                        displayAs: "",
                    },
                },
        ...
        test("The summary of properties will display an error if a simple property value is invalid", async () => {
            ...
            assertEquals(result, {...basicResultExpected, propertiesSummary: [
                ...
                // The related images property is still present:
                {
                    ...
                    rank: defaultData.schema.entryTypes._ETSPECIES.simplePropValues._CFSpeciesRelImg.rank,
