                        ...
                        {code: "CreateRelationshipFact", data: {
                            ...
                            {code: "UpdateEntryFeature", data: { entryId: data.entries.ponderosaPine.id, feature: { featureType: "Article",
                                articleMD: dedent`
                                    ...
                                    The National Register of Big Trees lists a ponderosa pine that is 235 ft (72 m) tall and 324 in (820 cm) in circumference.[20] In January 2011, a Pacific ponderosa pine in the Rogue River–Siskiyou National Forest in Oregon was measured with a laser to be 268.35 ft (81.79 m) high. The measurement was performed by Michael Taylor and Mario Vaden, a professional arborist from Oregon. The tree was climbed on October 13, 2011, by Ascending The Giants (a tree-climbing company in Portland, Oregon) and directly measured with tape-line at 268.29 ft (81.77 m) high. As of 2015, a Pinus lambertiana specimen was measured at 273.8 ft (83.45 m), which surpassed the ponderosa pine previously considered the world's tallest pine tree.
